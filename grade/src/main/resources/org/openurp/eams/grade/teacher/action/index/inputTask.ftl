...
[@b.toolbar title="教学班成绩录入"]
	bar.addBackOrClose();
[/@]
[#if (gradeInputSwitch.startAt)?? || true]
        ...
        <tr>
            <td align="center">
                <table style="padding:2%;width:100%">
                    ...
                    [/#if]
                        <td>[#if (gradeInputSwitch.startAt)??]起止时间:${gradeInputSwitch.startAt?string("yyyy-MM-dd HH:mm")}~gradeInputSwitch.endAt?string("yyyy-MM-dd HH:mm")[/#if]</td>
                    </tr>
                    <tr>
                        <td colspan="3">
