...
[#list courseStats as courseStat]
     [#assign teachTask=courseStat.lesson]
 	 <div align='center'><h3>[@i18nName teachTask.project.school?if_exists/]成绩分段统计表</h3></div>
 	 ...
 	 <table class="gridtable" style="width:95%" align="center">
 	 	...
 	 	<tr>
 	 	    ...
 	 	    <td width='40%'>${b.text('attr.courseName')}:${teachTask.course.name!}[#if teachTask.subCourse??]<sup>${teachTask.subCourse.name}</sup>[/#if]</td>
