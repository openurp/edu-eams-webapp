	...
	<table class="indexpanel">
		<tr>
			...
			[#assign extraSearchTR]
			    ...
			    [@b.radios name="status" items="0:未提交,2:已发布" value="0"/]
			    [#else]
			    [@b.radios name="status" items="0:未提交,1:已提交未发布,2:已发布" value="0"/]
			    [/#if]
			[/#assign]
			...
			<td class="index_content">
				[@b.div id="contentDiv" href="!search?lesson.semester.id=${(semester.id)?default('')}&statusGradeTypeId=${(gradeTypes?first.id)!}" /]
			</td>
		</tr>
	</table>
[@b.foot/]
