...
[#list courseStats as courseStat]
	...
	[@b.div style="text-align:center"]
		<h2>[@i18nName teachTask.project.school!/][@i18nName teachTask.project/]课程考核试卷分析表</h2>
...
<script>
   	...
   	[#--
   	function editReport() {
   		form.action = "${b.url('!editReport')}";
   		bg.form.addInput(form, "contentValue", jQuery("#contentValue").html(), "hidden");
   		form.submit();
   	}
   	--]
</script>
