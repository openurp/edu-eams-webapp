...
<style>
	...
	.tableStyle td { border: solid #000 1px; text-align:center}
</style> 
...
<table class="tableStyle" align="center">
  	<tr align="center">
  		[#list 1..2 as i]
	         <td width="26%">${b.text('课程名称')}</td>
	         <td width="7%" align="center">${b.text('attr.credit')}</td>
	         <td width="7%">${b.text('grade.score')}</td>
	         <td width="10%">${b.text('field.teacherEvaluate.term')}</td>
  		[/#list]
  	</tr>
	...
	<tr>
		...
		<td>${courseGrade.semester.schoolYear!}(${courseGrade.semester.name!})</td>
		[#else]
