...
[@b.grid items=gradeModifyApplys var="gradeModifyApply"]
	[@b.gridbar]
		[#if status.name() == 'ADMIN_AUDIT_PASSED']
		...
		[#elseif status.name()=='FINAL_AUDIT_UNPASSED']	
	...
	[@b.row]
		...
		[@b.col property="status" title="attr.graduate.auditStatus" width="8%"]${gradeModifyApply.status.fullName}[/@]
		...
		[@b.col property="applyReason" title="申请理由" width="8%"/]
