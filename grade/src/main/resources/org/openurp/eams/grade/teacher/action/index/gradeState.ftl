[#ftl/]
 ...
 [/#macro]
 [#macro getTeacherNames(teachers)]
   [#list teachers as t]${(t.person.name)!}[#if t_has_next],[/#if][/#list]
 [/#macro]
...
[#assign gradeStatus={'0':'新添加','1':'已提交','2':'已发布'}/]
    ...
    <table width="100%" class="infoTable">
        ...
        <tr>
            ...
            <td class="content">
            [#if gradeState?exists]
              ${gradeState.operator!}&nbsp;${gradeState.inputedAt!}
            [/#if]
            </td>
    ...
    <table class="gridtable">
       ...
       [#if gradeState?exists]
	        ...
	        <tr align="center">
	        	...
	        	<td>${state.operator!}&nbsp;${state.inputedAt!}</td>
	        </tr>
	        [/#list]
        [/#if]
    </table>
