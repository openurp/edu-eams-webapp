...
[@b.grid items=lessons var="lesson"]
	[@b.row]
		...
		[@b.col width="17%" title="期末总评成绩"]
			[@b.a href="/teach/grade/lesson/teacher-report!blank?lesson.id=${lesson.id}" target="_blank"]<U>空白登分册</U>[/@]
		...
		[@b.col width="17%" title="grade.makeupdelay"]
		  [#if (makeupTakeCounts.get(lesson)!0)>0]
			[@b.a href="/teach/grade/lesson/teacherReport!blank?lesson.id=${lesson.id}&makeup=1" target="_blank"]<U>空白登分册</U>[/@]
			[@b.a href="teacher-makeup!info?lessonId=${lesson.id}" target="_blank"]<U>查看</U>[/@]
