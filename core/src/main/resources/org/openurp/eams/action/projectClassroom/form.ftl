[#ftl]
[@b.head/]
[@b.toolbar title="修改项目教室配置"]bar.addBack();[/@]
[@b.tabs]
  [@b.form action="!update?id=${projectClassroom.id}" theme="list"]
    [@b.select name="projectClassroom.project.id" label="项目" value="${(projectClassroom.project.id)!}" required="true" 
