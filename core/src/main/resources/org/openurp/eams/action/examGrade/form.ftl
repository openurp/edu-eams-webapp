...
[@b.tabs]
  [@b.form action="!update?id=${examGrade.id}" theme="list"]
    [@b.radios label="是否通过"  name="examGrade.passed" value=examGrade.passed items="1:common.yes,0:common.no"/]
    [@b.radios label="是否提交"  name="examGrade.beyondSubmit" value=examGrade.beyondSubmit items="1:common.yes,0:common.no"/]
