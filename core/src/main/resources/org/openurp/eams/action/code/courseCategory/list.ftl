[#ftl]
[@b.head/]
[@b.grid items=courseCategorys var="courseCategory"]
  [@b.gridbar]
  ...
  [@b.row]
    ...
    [@b.col width="20%" property="beginOn" title="生效时间"]${courseCategory.beginOn!}[/@]
    [@b.col width="20%" property="endOn" title="失效时间"]${courseCategory.endOn!}[/@]
  [/@]
[/@]
[@b.foot/]
