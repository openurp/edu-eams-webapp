[#ftl]
[@b.head/]
[@b.toolbar title="修改外聘教师单位类别"]bar.addBack();[/@]
[@b.tabs]
  [@b.form action="!update?id=${teacherUnitType.id}" theme="list"]
    ...
    [@b.textfield name="teacherUnitType.remark" label="备注" value="${teacherUnitType.remark!}" maxlength="3"/]
    [@b.formfoot]
